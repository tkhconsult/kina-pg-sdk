...
class RefundRequest extends Request
{
    ...
    public function validateRequestParams()
    {
        ...
        if (!isset($this->_requestFields[self::INT_REF])
            ...
            throw new Exception('Refund request failed: invalid '.self::INT_REF);
        }
